...
----------Create Table for Dim_Customer-------------

CREATE TABLE Dim_Customer(
  DimCustomerID INTEGER IDENTITY(1,1) CONSTRAINT PK_dimCustomerID PRIMARY KEY NOT NULL -- SurrogateKey
...
----------View Dim_Customer table--------------

Select*From Dim_Customer;

-----------Delete Dim_Customer table--------

Drop table Dim_Customer;

------------Insert values into Dim_Customer---------

INSERT INTO Dim_Customer(DimLocationID,CustomerID,FullName,FirstName,LastName,Gender,EmailAddress,PhoneNumber)
VALUES (-1,'Unknown','Unknown','Unknown,Unknown','Unknown','Unknown','Unknown','Unknown');

INSERT INTO Dim_Customer(DimLocationID,CUSTOMERID,FullNAME,FIRSTNAME,LASTNAME,GENDER,EMAILADDRESS,PHONENUMBER)
Select Distinct DimLocationID,CUSTOMERID,CONCAT( FirstName, '' , LastName),FIRSTNAME,LASTNAME,GENDER,EMAILADDRESS,PHONENUMBER 
From Stage_Customer
...
----------------Delete Dim_Reseller table--------------------  


Drop Table Dim_Reseller;

--------------INSERT Values INTO DIm_Reseller--------------
...
Create Table Dim_store (
  ...
  DimStoreID INTEGER IDENTITY(1,1) CONSTRAINT PK_DimstoreID PRIMARY KEY NOT NULL, -- SurrogateKey,
  DimLocationID INTEGER CONSTRAINT FK_DimLocationIDCustomer FOREIGN KEY REFERENCES Dim_Location (DimLocationID) NOT NULL,
  ...
  -------------View Dim_Store Table -----------------
  
  Select * From Dim_Store;

  
  -------------- Delete Dim_Store Table -----------------
...
Create  table  Dim_Product(
  ProductID INT IDENTITY(1,1) CONSTRAINT PK_ProductID PRIMARY KEY NOT Null,
  SourceProductID INT,
  SourceProducttypeID INT,
  SourceProductCategoryID INT,
  ...
  ProdutProfitMargiunitpercent FLOAT
  );

  
  ---------View Dim_Product Table----------------
...
---------- INSERT Values into Dim_Product----------------
              
     
 
INSERT INTO Dim_Product (SourceProductID, SourceProducttypeID, SourceProductCategoryID, ProductName, Producttype, ProductCategory, ProductRetailPrice, ProductWholesalePrice, ProductCost, ProductRetailProfit, ProductWholeSaleUnitProfit, ProdutProfitMargiunitpercent)
...
INSERT INTO Dim_Product (SourceProductID, SourceProducttypeID, SourceProductCategoryID, ProductName, Producttype, ProductCategory, ProductRetailPrice, ProductWholesalePrice, ProductCost, ProductRetailProfit, ProductWholeSaleUnitProfit, ProdutProfitMargiunitpercent)
SELECT distinct ProductID, Stage_Product.ProducttypeID,Stage_ProductCategory.ProductCategoryID, Product, Producttype, ProductCategory, Price, WholesalePrice, Cost, Price - Cost AS ProductRetailProfit, Wholesaleprice - Cost AS ProductWholeSaleUnitProfit, (((Price-Cost)/Price)*100) AS ProdutProfitMargiunitpercent
FROM Stage_Product
